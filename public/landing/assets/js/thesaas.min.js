    ...
    (c.config = function(d) {
      ...
      if (
        ...
        c.defaults.googleAnalyticsId &&
          ...
          ga('send', 'pageview')),
        a('[data-provide~="recaptcha"]').length && void 0 === b.grecaptcha)
      ) {
        var e =
        ...
        a(document).on('click', '[data-scrollto]', function() {
          ...
          if (a(c).length > 0) {
            ...
            a('.topbar.topbar-sticky').length && (d = 60),
              b.animate({ scrollTop: a(c).offset().top - d }, 1e3)
          }
          return !1
        })
    ...
    (c.counter = function() {
      ...
      a('[data-countdown]').each(function() {
        ...
        ;(b += '<div class="row gap-items-3">'),
          (b += '<div class="col"><h5>%D</h5><small>Day%!D</small></div>'),
        ...
        a(document).on(
          ...
          function() {
            a(this).hasDataAttr('scrollto') &&
              (c.removeClass('topbar-reveal'), a('.topbar-backdrop').remove())
          },
        )
    }),
    (c.typed = function() {
    ...
    (c.contact = function() {
      a(document).on('click', '#contact-send', function() {
        var b = a('#contact-name').val(),
          ...
          g = a('#contact-error')
        return c.length < 1
          ? void g.html('Please enter your email address.').fadeIn(500)
          : f.test(c)
            ? void a.ajax({
                type: 'POST',
                ...
                success: function() {
                  g.fadeOut(400),
                    ...
                    a('#contact-name, #contact-email, #contact-message').val('')
                },
                error: function() {
                  g.html(
              ...
              : e.length && e.val().length < 1
                ...
                : (a
                    ...
                    .done(function(b) {
                      var d = a.parseJSON(b)
                      'success' == d.status
                        ? (c.find('.alert-success').fadeIn(1e3),
                          c.find(':input').val(''))
                        : (c.prepend(
              ...
              a(d)
                ...
                .each(function() {
                  a(this).on('click', function() {
                    ...
                    var g
                    d
                      ? (b.removeClass('active'), (g = c.ALL_ITEMS))
