...
class Api::SignalsTelegramBot::TradingSignalsTest < Api::SignalsTelegramBot::BaseTest
  test "show" do
    ...
    get "/api/signals_telegram_bot/trading_signals/#{trading_signal.id}", headers: auth_headers
  ...
  test "create" do
    ...
    assert_difference 'TradingSignal.count', 1 do
      post "/api/signals_telegram_bot/trading_signals", params: request_params, headers: auth_headers, as: :json
    end
