...
class Api::SignalsTelegramBot::TradingSignalTriggersTest < Api::SignalsTelegramBot::BaseTest
  test "show" do
    trading_signal_triggers = create_list(:trading_signal_trigger, 3)
    trading_signal_trigger = trading_signal_triggers.sample

    get "/api/signals_telegram_bot/trading_signal_triggers/#{trading_signal_trigger.id}", headers: auth_headers
  ...
  test "create" do
    ...
    assert_difference 'TradingSignalTrigger.count', 1 do
      post "/api/signals_telegram_bot/trading_signal_triggers", params: request_params, headers: auth_headers, as: :json
    end
