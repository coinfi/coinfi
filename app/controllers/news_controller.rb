class NewsController < ApplicationController
  ...
  prepend_before_action :set_amp, only: [:index, :show]
  ...
  def coin_index
    ...
    @news_items = NewsItems::WithFilters.call(NewsItem.published, coins: [coin])
      ...
      .order_by_published
      .limit(25)
    @news_items_data = serialize_news_items(@news_items)
  ...
  def set_default_news_items
    ...
    @news_items = NewsItem.where(id: news_item_ids).order_by_published
    @news_items_data = serialize_news_items(@news_items)
  end
