module CoinMarketCapPro
  class RefreshMarketPairsCacheService < Patterns::Service
    ...
    def call
      ...
      puts "About to process #{coins.length} coins"
      puts "Nothing to do here. items was empty... bye." and return if coins.none?

      progress = ProgressBar.create(:title => "coins", :total => exchanges.length)
      items_with_errors = []
