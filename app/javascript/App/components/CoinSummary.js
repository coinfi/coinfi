    ...
    <div className="col-xs-12 col-md-4 flex flex-column">
            ...
            <div className="relative">
              <div className="search-input icon-input tiber">
                <div className="icon f4 reveal-m">
                  <svg
                    className="svg-inline--fa fa-search fa-w-16 pr1"
                    aria-hidden="true"
                    data-prefix="far"
                    data-icon="search"
                    role="img"
                ...
                <button className="btn-icon icon silver conceal-m">
                  <svg
                    className="svg-inline--fa fa-arrow-left fa-w-14 pr1"
                    aria-hidden="true"
                    data-prefix="far"
      ...
      <div className="bg-white mb2">
        ...
        <div className="pa4 pt0">
          ...
          <div className="f3 tc">
            $6,594.36<span className="smaller2 b ml2">
              <span className="green">+3.56%</span>
            </span>
          </div>
        </div>
      </div>
