    ...
    <div className="lh-copy">
      <div>
        <div style={{paddingTop:'15px', height:60, borderBottom: '1px solid rgba(0, 0, 0, 0.12)' }}>
          ...
          <h2 className='mt0' style={titleStyle}>CoinFi Exchange Listings</h2>
        </div>
        <div style={{margin:20}}>
          ...
          <ol className='tips'>
            <li>
              ...
              <div style={listTextNodeStyle}>
                Add coins to your watchlist <img src={listIcon} /> to receive notifications on your exchange listings when you subscribe.
              </div>
            </li>
            <li>
              <div style={listNumberStyle}>2</div>
              <div style={listTextNodeStyle}>
                Use filters <img src={filterIcon} /> to drill down on specific exchanges, coins, or dates of listings.
              </div>
            </li>
            <li>
              <div style={listNumberStyle}>3</div>
              <div style={listTextNodeStyle}>
                Click on a coin to see how historical exchange listings have impacted the price over time <img src={chartIcon} />
              </div>
            </li>
            <li>
              <div style={listNumberStyle}>5</div>
              <div style={listTextNodeStyle}>
                Enable email and browser push notifications to stay up-to-date on new exchange listings for your portfolio.
              </div>
            </li>
          </ol>
        </div>
        ...
        {!userIsLoggedIn && (
          <div style={{paddingTop:'15px'}} className='signup-cta-wrap'>
            <h2 className='tc mt0'>Get the most out of CoinFi Exchange Listings</h2>
